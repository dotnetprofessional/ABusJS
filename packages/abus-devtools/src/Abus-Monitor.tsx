...
import { IBus, IMessageHandlerContext, IMessage, newGuid, IMessageTask, handler } from "abus";
...
export class ABusMonitor extends React.PureComponent<{ bus: IBus }, { isVisible: boolean, toggle: boolean }> {
